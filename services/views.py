...
con=mysql.connector.connect(database='bank',user='root',password='')
cur=con.cursor()
...
def adminlogin(request):  
    template = loader.get_template('adminlogin.html') # getting our template  
    return HttpResponse(template.render()) 

def employlogin(request):  
    template = loader.get_template('employlogin.html') # getting our template  
    return HttpResponse(template.render())

def addemploy(request):  
    template = loader.get_template('addEmploy.html') # getting our template  
    return HttpResponse(template.render())
def addcustomer(request):  
    template = loader.get_template('addCustomer.html') # getting our template  
    return HttpResponse(template.render())
...
def EmployLoginDB(request):
    ...
    if len(d)>0:
        ...
        template = loader.get_template('employhome.html') # getting our template  
        return HttpResponse(template.render())
    else:
        template = loader.get_template('employlogin.html') # getting our template  
        return HttpResponse(template.render()) 
...
def viewemploy(request):
    ...
    return render(request,"viewemploy.html",{'employees':employees})
...
def ViewProfile(request):
    ...
    employees = Employee.objects.filter(id=eid)
    return render(request,"profileemploy.html",{'employees':employees})
...
def deposit(request):
    template = loader.get_template('deposit.html') # getting our template  
    return HttpResponse(template.render())
...
def withdrawl(request):
    template = loader.get_template('withdrawl.html') # getting our template  
    return HttpResponse(template.render())
...
def transfer(request):
    template = loader.get_template('transfer.html') # getting our template  
    return HttpResponse(template.render())
